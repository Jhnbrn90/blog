...
Date: 2020-09-17
Image: posts/contributing-to-a-PHP-package/cover.png
Summary: Contributing to packages instead of applications can look challenging. In this blog post I want to show a workflow to work on PHP packages and be able to test them out locally.
---
...
It is **important** to commit your changes to a branch other than the `master` branch on your fork, since maintainers (or others) might want to push changes to your branch which is impossible if you create a PR from your `master` branch. Thanks to Caleb ([@calebporzio](https://twitter.com/calebporzio)) for this [explanation on twitter](https://twitter.com/calebporzio/status/1308734324175495169):
...
![Creating a new PR from a fork](images/posts/contributing-to-a-PHP-package/create-pr.png)
