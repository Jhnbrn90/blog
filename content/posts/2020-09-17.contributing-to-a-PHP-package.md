...
It is **important** to commit your changes to a branch other than the `master` branch on your fork, since maintainers (or others) might want to push changes to your branch which is impossible if you create a PR from your `master` branch. Thanks Caleb, for this [explanation on twitter](https://twitter.com/calebporzio/status/1308734324175495169):
